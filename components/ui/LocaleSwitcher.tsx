...
const ring = {'--c': '6px'} as CSSProperties;
...
export default function LocaleSwitcher() {
  ...
  return (
    <span className="chamfer-ring" style={ring}>
      <button
        type="button"
        onClick={onSelect}
        disabled={isPending}
        ...
        className="chamfer-quad relative h-8 w-14.5 transition-colors disabled:opacity-70"
      >
        <span
          style={{
            ...knob,
